                                ...
                                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <?php if(count($menu->children)): ?>
                                            <i class="mdi mdi-menu-down menu-switch" id="<?php echo e($menu->id); ?>" state="on"></i>
                                        <?php endif; ?>
                                        ...
                                        <td>
                                            <?php $__currentLoopData = $menu->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label class="badge badge-success"><?php echo e($role->name); ?></label>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </td>
                                        <td><?php echo e($menu->created_at); ?></td>
                                        <td><?php echo e($menu->updated_at); ?></td>
                                        <td>
                                            <button type="button" class="btn btn-sm btn-gradient-dark btn-icon-text" onclick="update(<?php echo e($menu->id); ?>)">
                                                修改
                                                <i class="mdi mdi-file-check btn-icon-append"></i>
                                            </button>
                                            <button type="button" class="btn btn-sm btn-gradient-danger btn-icon-text" onclick="del(<?php echo e($menu->id); ?>)">
                                    ...
                                    <?php if(count($menu->children)): ?>
                                        <?php $__currentLoopData = $menu->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childmenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="pid-<?php echo e($menu->id); ?>">
                                                <td>　　　　 <?php echo e($childmenu->name); ?></td>
                                                <td><?php echo e($childmenu->url); ?></td>
                                                <td>
                                                    <?php $__currentLoopData = $childmenu->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <label class="badge badge-success"><?php echo e($role->name); ?></label>

                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </td>
                                                <td><?php echo e($childmenu->created_at); ?></td>
                                                <td><?php echo e($menu->updated_at); ?></td>
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-gradient-dark btn-icon-text" onclick="update(<?php echo e($childmenu->id); ?>)">
                                                        修改
                                                        <i class="mdi mdi-file-check btn-icon-append"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-gradient-danger btn-icon-text" onclick="del(<?php echo e($childmenu->id); ?>)">
                                                        <i class="mdi mdi-delete btn-icon-prepend"></i>
                                                        删除
                                                    </button>
                                                </td>
