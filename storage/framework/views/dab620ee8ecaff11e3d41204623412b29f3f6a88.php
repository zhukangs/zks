                            ...
                            <table class="table table-bordered">
                                ...
                                <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                        <?php if($admin->avatar): ?>
                                            <img class="avatar" src="<?php echo e($admin->avatar ?? ""); ?>" alt="image">
                                        <?php endif; ?>
                                        </td>
                                        <td><?php echo e($admin->nickname); ?></td>
                                        <td><?php echo e($admin->account); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-gradient-dark btn-icon-text" onclick="update(<?php echo e($admin->id); ?>)">
                                                修改
                                                <i class="mdi mdi-file-check btn-icon-append"></i>
                                            </button>
                                            <button type="button" class="btn btn-sm btn-gradient-danger btn-icon-text" onclick="del(<?php echo e($admin->id); ?>)">
