...
<div class="container-scroller">
  ...
  <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      <a class="navbar-brand brand-logo" href="/"><img src="<?php echo e(getConfig("admin_logo") != '' ? getConfig("admin_logo") : '/uploads/config/logo.png'); ?>" alt="logo"/></a>
                  ...
                  <li class="nav-item">
                      ...
                      <div class="collapse" id="system-pages-<?php echo e($v->id); ?>">
                          <ul class="nav flex-column sub-menu">
                              <?php $__currentLoopData = $v->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
